...
def prep_excel_file(base_excelfile, log_file):
    ...
    new_filepath = path.dirname(base_excelfile)+"\\"+file_basename+"-calc.xlsx"
...
def main(baseexcel_filename, file_name):
    """ main logic for each thread created """
    calc_file = prep_excel_file(baseexcel_filename, file_name)
